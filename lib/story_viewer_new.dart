          ...
          children: [
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildStoryContent(_userStories[index], colors);
              },
            ),
  ...
  Widget _buildStoryContent(Story story, ColorScheme colors) {
    switch (story.mediaType) {
      ...
      case StoryMediaType.video:
        return Container(
          color: colors.onInverseSurface,
          child: const Center(child: Icon(Icons.play_circle_filled, size: 64)),
        );
      ...
      // FIXED: Added default return to prevent 'body_might_complete_normally' error
      default:
